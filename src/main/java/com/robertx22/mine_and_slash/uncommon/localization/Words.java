...
public enum Words implements IAutoLocName {
    ...
    ThornArmor("Thorn Armor"), Recharge("Recharge"),
    ...
    Fireball("Fireball"), FireBomb("Fire Bombs"), ElectricalDischarge("Electrical Discharge"),
    ...
    Thunderstorm("Thunderstorm"), Stealth("Stealth"), UnholyMeditation("Unholy Meditation"), SummonZombie("Summon Zombie"),
