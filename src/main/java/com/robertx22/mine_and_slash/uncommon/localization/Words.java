...
public enum Words implements IAutoLocName {
    ...
    RallyingSweepLinker("Rallying Sweep Linker"), SpiritDrainLinker("Spirit Drain Linker"), EmpoweringFinisher("Empowering Finisher"),
    AntiGravityFinisher("Anti-Gravity Finisher"), OmnislashFinisher("Omnislash Finisher"),
