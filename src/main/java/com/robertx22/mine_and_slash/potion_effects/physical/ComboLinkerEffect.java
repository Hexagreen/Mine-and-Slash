...
public class ComboLinkerEffect extends BasePotionEffect implements IApplyStatPotion {

    public static final ComboLinkerEffect INSTANCE = new ComboLinkerEffect();

    private ComboLinkerEffect() {
        super(EffectType.BENEFICIAL, 4393423);
        this.setRegistryName(new ResourceLocation(Ref.MODID, GUID()));

        this.tickActions.add(new OnTickAction(ctx -> {
            ParticleUtils.spawnParticles(ParticleRegister.THUNDER, ctx.entity, 15);
            return ctx;
        }, null));
    }
    ...
    public List<PotionStat> getPotionStats() {
        ...
        list.add(new PotionStat(15, FasterCastRate.getInstance()));
        return list;
    }
