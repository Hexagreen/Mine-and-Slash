...
public class OmnislashFinisherSpell extends BaseSpell {

    private OmnislashFinisherSpell() {
        super(
    ...
    public static OmnislashFinisherSpell getInstance() {
        return OmnislashFinisherSpell.SingletonHolder.INSTANCE;
    }
    ...
    public Words getName() {
        return Words.OmnislashFinisher;
    }

    private static class SingletonHolder {
        private static final OmnislashFinisherSpell INSTANCE = new OmnislashFinisherSpell();
    }
}