...
public class PowerFormSpell extends BaseSpell {

    private PowerFormSpell() {
        ...
        }.addsEffect(EmpowerEffect.INSTANCE)
            .setSwingArmOnCast());
    }

    public static PowerFormSpell getInstance() {
    ...
    public Words getName() {
        return Words.PowerForm;
    }

    private static class SingletonHolder {
        private static final PowerFormSpell INSTANCE = new PowerFormSpell();
    }
}
