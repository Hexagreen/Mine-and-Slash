...
public class HeavyStrikeEnrageSynergy extends OnAttackSpellDmgDoneSynergy {
    ...
    public List<ITextComponent> getSynergyTooltipInternal(TooltipInfo info) {
        ...
        list.add(new StringTextComponent(TextFormatting.GRAY + "" + TextFormatting.ITALIC + "Modifies Martyrdom"));

        TooltipUtils.addEmpty(list);

        list.add(new StringTextComponent(Spells.HitApplyEffect.locName().getString() + EnrageEffect.INSTANCE.locNameForLangFile()));
    ...
    public IAbility getRequiredAbility() {
        return HeavyStrikeSpell.getInstance();
    }
