...
public class ArrowTotemSpell extends BaseSpell {
    ...
    public PreCalcSpellConfigs getPreCalcConfig() {
        ...
        c.set(SC.ATTACK_SCALE_VALUE, 0.9F, 2.0F);
    ...
    public List<ITextComponent> GetDescription(TooltipInfo info, SpellCastContext ctx) {
        ...
        list.add(new StringTextComponent(TextFormatting.GRAY + "" + TextFormatting.ITALIC + SpellType.getSpellTypeStr(Spells.Area, Spells.Duration, Spells.Entity)));
