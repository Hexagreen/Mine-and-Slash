...
public class FlameBlitzSpell extends BaseSpell {
    ...
    public static FlameBlitzSpell getInstance() {
        return FlameBlitzSpell.SingletonHolder.INSTANCE;
    }
    ...
    public List<ITextComponent> GetDescription(TooltipInfo info, SpellCastContext ctx) {
        ...
        list.add(new StringTextComponent(TextFormatting.GRAY + "" + TextFormatting.ITALIC + SpellType.getSpellTypeStr(Arrays.asList(Spells.Channel, Spells.Melee))));
