...
public class GoadingStrikeSpell extends BaseSpell {

    private GoadingStrikeSpell() {
        super(
    ...
    public void castExtra(SpellCastContext ctx) {
        ...
        pdata.radius = radius;
        ParticleEnum.PROVOKE.sendToClients(ctx.caster, pdata);
    ...
    public static GoadingStrikeSpell getInstance() {
        return GoadingStrikeSpell.SingletonHolder.INSTANCE;
    }
    ...
    public PreCalcSpellConfigs getPreCalcConfig() {
        ...
        c.set(SC.ATTACK_SCALE_VALUE, 1.3F, 1.95F);
    ...
    public List<ITextComponent> GetDescription(TooltipInfo info, SpellCastContext ctx) {
        ...
        list.add(new StringTextComponent(TextFormatting.GRAY + "" + TextFormatting.ITALIC + SpellType.getSpellTypeStr(Spells.Area, Spells.Melee, Spells.Taunt)));
        ...
        TooltipUtils.addEmpty(list);
        list.add(new StringTextComponent(TextFormatting.GRAY + Spells.GenerateEffect.getLocNameStr() + ComboStarterEffect.INSTANCE.locNameForLangFile()));
        TooltipUtils.addEmpty(list);
    ...
    public Words getName() {
        return Words.GoadingStrike;
    }

    private static class SingletonHolder {
        private static final GoadingStrikeSpell INSTANCE = new GoadingStrikeSpell();
    }
}