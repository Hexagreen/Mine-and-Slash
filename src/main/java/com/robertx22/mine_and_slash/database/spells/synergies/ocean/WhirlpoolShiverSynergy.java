...
public class WhirlpoolShiverSynergy extends OnDamageDoneSynergy {
    ...
    public List<ITextComponent> getSynergyTooltipInternal(TooltipInfo info) {
        ...
        list.add(new StringTextComponent(TextFormatting.GRAY + "" + TextFormatting.ITALIC + "Modifies Whirlpool"));

        TooltipUtils.addEmpty(list);

        list.add(new StringTextComponent(Spells.HitApplySelfBuff.locName().getString() + ColdEssenceEffect.INSTANCE.locNameForLangFile()));
