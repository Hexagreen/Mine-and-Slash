...
public class DebilitatingStrikeSpell extends BaseSpell {
    ...
    public PreCalcSpellConfigs getPreCalcConfig() {
        ...
        c.set(SC.ENERGY_COST, 5, 8F);
        c.set(SC.MAGIC_SHIELD_COST, 0, 0);
        c.set(SC.BASE_VALUE, 0, 0);
        c.set(SC.ATTACK_SCALE_VALUE, 1.45F, 2.05F);
    ...
    public List<ITextComponent> GetDescription(TooltipInfo info, SpellCastContext ctx) {
        ...
        list.add(new StringTextComponent(TextFormatting.GRAY + "" + TextFormatting.ITALIC + SpellType.getSpellTypeStr(Spells.Debuff, Spells.Duration, Spells.Melee)));
